...
class ArticleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('admin.article.index')->with(['type' => 'success', 'message' =>'Post Saved.']);
        } catch (Throwable $th) {
            Log::create([
                'model' => 'article',
    ...
    public function update(Request $request, Article $article)
    {
        ...
        try {
            ...
            return redirect()->route('admin.article.index')->with(['type' => 'success', 'message' =>'The Post Has Been Updated.']);
